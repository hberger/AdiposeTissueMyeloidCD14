...
sample = "complete_Ramachandran_NAFLD_secreted_no_mobile_diseased_only"
...
The database of secreted ligands is used. Mobile populations from PBMC and healthy liver and adipose tissue samples as well as Mo/MoMF/DC populations from liver are excluded.  
...
if (reload_data) {
  ...
  scData$cluster_label_ds = factor(paste0(scData$cluster_label, "_", scData$DS))
