---
title: "CellChat analysis of cluster in all NAFLD + all Ramachandrand samples. Only secreted ligands. Excluding mobile populations from PBMC."
...
sample = "complete_Ramachandran_NAFLD_secreted_no_mobile"
...
if (reload_data) {
  ...
  scData = subset(scData.combined, group != "fibrotic_PBMC" & cluster_label != "T/NK-Cell 2")
