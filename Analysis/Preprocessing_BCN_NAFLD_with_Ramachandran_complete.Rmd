---
title: "BCN NAFLD scData, plus liver CD45+ and PBMC reference samples from Ramachandran (CD45+ and CD45-) et al. - Preprocessing"
...
if(reload_data) {
  ...
  load("../../DataSets/GSE136103_Cirrhotic_Ramachandran/Analysis_all_cells/Results/data_storage/2022-01-19/All_Filtered_scData.Rdata", ramachandran_env)
...
```{r}
split_data_file = "BCN_NAFLD_Ramachandran_complete_preprocessing_split_data.Rdata"
if(reload_data) {
...
```{r}
final_data_file = file.path(data_storage_folder, "BCN_NAFLD_and_Ramachandran_complete.combined.RData")
