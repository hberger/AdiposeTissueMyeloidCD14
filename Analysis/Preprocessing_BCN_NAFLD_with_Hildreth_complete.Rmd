...
rownames(old_labels_hildreth) = old_labels_hildreth$orig_cell_id

scData.combined@meta.data$labels_hildreth = NA
scData.combined@meta.data$labels_hildreth = old_labels_hildreth[scData.combined$orig_cell_id, "cluster_label"]
